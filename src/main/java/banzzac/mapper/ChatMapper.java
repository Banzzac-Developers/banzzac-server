...
public interface ChatMapper {
	...
	@Select("SELECT "
			+ "    c.*, "
			+ "    CASE "
			+ "        WHEN c.room_member_1 = 'zkdlwjsxm@example.com' THEN m2.id "
			+ "        WHEN c.room_member_2 = 'zkdlwjsxm@example.com' THEN m1.id "
			+ "    END AS opponent_id, "
			+ "    CASE "
			+ "        WHEN c.room_member_1 = 'zkdlwjsxm@example.com' THEN m2.nickname"
			+ "        WHEN c.room_member_2 = 'zkdlwjsxm@example.com' THEN m1.nickname"
			+ "    END AS member_nickname, "
			+ "    CASE "
			+ "        WHEN c.room_member_1 = 'zkdlwjsxm@example.com' THEN m2.img "
			+ "        WHEN c.room_member_2 = 'zkdlwjsxm@example.com' THEN m1.img "
			+ "    END AS member_img, "
			+ "    CASE "
			+ "        WHEN c.room_member_1 = 'zkdlwjsxm@example.com' THEN d2.name "
			+ "        WHEN c.room_member_2 = 'zkdlwjsxm@example.com' THEN d1.name "
			+ "    END AS dog_name, "
			+ "    CASE "
			+ "        WHEN c.room_member_1 = 'zkdlwjsxm@example.com' THEN d2.img "
			+ "        WHEN c.room_member_2 = 'zkdlwjsxm@example.com' THEN d1.img "
			+ "    END AS dog_img, "
